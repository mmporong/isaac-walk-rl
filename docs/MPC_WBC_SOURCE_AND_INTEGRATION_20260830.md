...
처음 학습하는 경우 이 기술 검토서보다 [`learning/mpc_wbc/README.md`](learning/mpc_wbc/README.md)의 여섯 개 초보자 설명 문서를 먼저 읽는다. 각 설명 문서는 Notion 원문 한 페이지에 하나씩 대응하며 쉬운 물리 설명, 최소 수식, 원문 절 대응표와 확인 문제를 포함한다.
